    ...
    <header style={{
      ...
      <div style={{
        ...
        <Link href="/" style={{
          ...
          display: "inline-flex", alignItems: "center", gap: 10, fontSize: 22, flexShrink: 0,
        }}>
          <img src="/logo.png" alt="Pino Galant" style={{ width: 58, height: 58, objectFit: "contain", flexShrink: 0 }} />
